        ...
        <div className="mx-auto max-w-7xl px-6 py-24 sm:py-32 lg:flex lg:items-center lg:gap-x-10 lg:px-8 lg:py-40">
          <div className="mx-auto max-w-2xl lg:mx-0 lg:flex-auto">
            <h1 className="mt-10 max-w-lg text-4xl font-bold tracking-tight text-ai-title-regular sm:text-6xl">
              Streamline Your Car Repair Workflow
            </h1>
            <p className="mt-6 text-lg leading-8 text-ai-subtext-regular">
              Our car repair solution addresses common pain points in vehicle maintenance, enabling professionals to enhance productivity and ensure higher customer satisfaction.
            </p>
